...
<?php
	...
	getQueryResult($link, 'create table transactions (id int(100) unsigned auto_increment primary key, email varchar(32) not null, accountName varchar(32) not null, merchant varchar(32) not null, amount float(32) not null, category varchar(32) not null, asset int(2) not null);');
	getQueryResult($link, 'alter table transactions add column `date` datetime(0) after category;');
